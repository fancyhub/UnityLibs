...
namespace FH.UI
{
    ...
    /// </summary>
    public class ScrollCuller : IScrollCuller
    {
        public bool _in_stack = false;
        public List<IScrollItem> _temp_list_to_invisible = new List<IScrollItem>();       
        ...
        public bool Cull(IScroll scroller)
        {
            ...
            foreach (var a in item_list)
            {
                ...
                _temp_list_to_invisible.Add(a);
            }

            foreach (var a in _temp_list_to_invisible)
            {
                a.CullVisible = false;
            }
            _in_stack = false;
