/*************************************************************************************
 * Author  : cunyu.fan
 * Time    : 2021/6/4 11:53:02
 * Title   : 
 * Desc    : 增加这个类,是为了方便 增加 EvntClick的全局消息,为了方便 Tips类型的点击事件,基于 com.unity.ugui@1.0.0, StandaloneInputModule 修改的 , 原来的类也复制到本目录了, 方便比较
*************************************************************************************/
...
{    
    ...
    /// </remarks>
    public class FHStandaloneInputModule : PointerInputModule
    {       
        ...
        protected FHStandaloneInputModule()
        {
        }
        ...
        private void ReleaseMouse(PointerEventData pointerEvent, GameObject currentOverGo)
        {
            ...
            {
                UIBGEvent.GlobalEventClick?.Invoke(pointerEvent.pointerClick);
        ...
        protected void ProcessTouchPress(PointerEventData pointerEvent, bool pressed, bool released)
        {
            ...
            if (pressed)
            {
                ...
                UIBGEvent.GlobalEventDown?.Invoke(currentOverGo);
