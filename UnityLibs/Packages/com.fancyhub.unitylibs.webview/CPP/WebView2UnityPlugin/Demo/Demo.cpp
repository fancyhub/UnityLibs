...
#include "framework.h"
#include "Demo.h"
#include "../WebView2UnityPlugin/WebView2UnityPlugin.h"
#include <cstdio>
#include <wrl.h>
...
//L"http://localhost:5000/test_js.html"
const wchar_t* url = L"https://www.google.com/ncr";
...
static INT32 globalWebViewID = 0;
static HWND globalHwnd;


void OnMessageCallBack(INT32 webViewId, BSTR msg)
{
	WebViewClose(webViewId);
	globalWebViewID = WebViewCreate(globalHwnd, url, 0, 0, 1, 1);
	SysFreeString(msg);
}


void OnJsLogCallBack(INT32 webViewId, BSTR msg)
{
