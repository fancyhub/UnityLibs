...
namespace FH
{
    public interface IUIPageTag : IUIPage
    {
    ...
    public sealed class UIPageTagMatrix
    {
        ...
        private MyDict<int, (byte tag, CPtr<IUIPageTag> page)> _dict_tag;
        private Dictionary<int, ulong> _dict_hide_mask;
        private Bit64 _hide_mask = Bit64.Zero;

        public UIPageTagMatrix()
        {
            _dict_tag = new MyDict<int, (byte, CPtr<IUIPageTag>)>();
        ...
        public bool AddPage(IUIPageTag page, byte page_tag)
        {
            ...
            _dict_tag.Add(page.Id, (page_tag, new CPtr<IUIPageTag>(page)));
