...
final class PermissionUtils {
    ...
    static boolean areActivityIntent(@NonNull Context context,  Intent intent) {
        if (intent == null) {
            return false;
        }
...
//        }
     ...
     */
    static Intent getSmartPermissionIntent(@NonNull Context context,  List<String> permissions) {
        // 如果失败的权限里面不包含特殊权限
