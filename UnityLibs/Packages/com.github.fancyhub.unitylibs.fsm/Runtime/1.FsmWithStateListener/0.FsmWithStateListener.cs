...
namespace FH
{
    ...
    /// </summary>
    public class FsmWithStateListener<TState, TMsg, TStateTranMap> : IFsm<TState, TMsg, TMsg, TStateTranMap>
    ...
    /// 没有 StateVirtualTable的 Fsm
    /// </summary>
    public class FsmWithStateListener<TState, TMsg> : FsmWithStateListener<TState, TMsg, IFsmStateTranMap<TState, TMsg>>
    {
        public FsmWithStateListener(
            EFsmMode mode = EFsmMode.Sync,
